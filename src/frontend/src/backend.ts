...
export class Backend implements backendInterface {
    ...
    async createNotice(arg0: Notice): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getNotice(arg0: string): Promise<Notice> {
        if (this.processError) {
            try {
    ...
    async updateNotice(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateNotice(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
